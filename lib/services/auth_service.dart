...
class AuthService extends ChangeNotifier {
  ...
  Future<UserRole?> getUserRole(String uid) async { final doc = await _db.collection('users').doc(uid).get(); if(!doc.exists) return null; return userRoleFromString(doc.data()!['rol'] as String); }
